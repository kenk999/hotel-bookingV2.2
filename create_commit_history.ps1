...
$commitGroups = @(
    ...
    @{
        Date = "2024-07-10"
        Time = "15:38:27"
        Files = @("src/index.js", "src/App.jsx", "src/app.css", "public/index.html")
    ...
    @{
        Date = "2024-07-16"
        Time = "08:42:33"
        Files = @("src/components/navbar/Navbar.jsx", "src/components/navbar/navbar.css")
    ...
    @{
        Date = "2024-07-21"
        Time = "12:07:45"
        Files = @("src/assets/bang.jpg", "src/assets/Del.jpg", "src/assets/Mum.jpg")
        Message = "Add city images and visual assets"
    },
    @{
        Date = "2024-07-23"
        Time = "14:53:19"
        Files = @("src/components/featured/Features.jsx", "src/components/featured/featured.css")
        Message = "Create featured cities component with analytics"
    },
    @{
        Date = "2024-07-25"
        Time = "19:16:42"
        Files = @("src/components/propertyList/PropertyList.jsx", "src/components/propertyList/propertyList.css")
        Message = "Implement property type browsing functionality"
    },
    @{
        Date = "2024-07-27"
        Time = "11:44:58"
        Files = @("src/components/featuredProperties/FeaturedProperties.jsx", "src/components/featuredProperties/featuredProperties.css")
        Message = "Add featured properties showcase component"
    },
    @{
        Date = "2024-07-29"
        Time = "16:29:13"
        Files = @("src/pages/home/Homes.jsx", "src/pages/home/home.css")
        Message = "Create main homepage layout and styling"
    },
    @{
        Date = "2024-07-31"
        Time = "09:35:27"
        Files = @("src/pages/list/List.jsx", "src/pages/list/list.css")
        Message = "Implement hotel search and filtering page"
    },
    @{
        Date = "2024-08-02"
        Time = "21:18:36"
        Files = @("src/components/searchItem/SearchItem.jsx", "src/components/searchItem/searchItem.css")
        Message = "Create hotel search result item component"
    },
    @{
        Date = "2024-08-04"
        Time = "13:52:41"
        Files = @("src/pages/hotel/Hotel.jsx", "src/pages/hotel/hotel.css")
        Message = "Add detailed hotel view with image gallery"
    },
    @{
        Date = "2024-08-06"
        Time = "10:07:22"
        Files = @("src/components/reserve/Reserve.jsx", "src/components/reserve/reserve.css")
    ...
    @{
        Date = "2024-08-09"
        Time = "12:21:33"
        Files = @("src/components/mumbai/mumbai.css", "src/components/delhi/delhi.css", "src/components/bengaluru/bengaluru.css")
        Message = "Add styling for city-specific components"
    },
    @{
        Date = "2024-08-09"
        Time = "20:14:57"
    ...
    @{
        Date = "2024-08-10"
        Time = "08:39:44"
        Files = @("src/components/footer/Footer.jsx", "src/components/footer/footer.css", "src/components/mailList/MailList.jsx", "src/components/mailList/mailList.css")
        Message = "Add footer and newsletter subscription components"
    },
    @{
        Date = "2024-08-10"
        Time = "11:28:16"
        Files = @("src/components/comingSoon/ComingSoon.jsx", "src/components/comingSoon/comingSoon.css")
        Message = "Create coming soon page for future features"
    },
    @{
        Date = "2024-08-10"
        Time = "14:55:39"
        Files = @("api/.ebextensions/00_install_certbot.config", "api/.ebextensions/01_nginx_proxy.config", "api/.ebextensions/02_environment.config", "api/.ebextensions/10_open_https_port.config")
        Message = "Add AWS Elastic Beanstalk deployment configuration"
    },
    @{
        Date = "2024-08-10"
        Time = "17:42:11"
        Files = @("api/.platform/hooks/postdeploy/00_get_certificate.sh", "api/Procfile")
        Message = "Configure SSL certificates and deployment scripts"
    },
    @{
        Date = "2024-08-10"
        Time = "19:33:28"
...
function Create-CommitWithDate {
    ...
    if ($existingFiles.Count -gt 0) {
        ...
        Write-Host "✗ No files to commit`n" -ForegroundColor Red
    }
}

# Execute commits
Write-Host "`nStarting commit history creation..." -ForegroundColor Green
Write-Host "Repository: $repoUrl" -ForegroundColor Cyan
Write-Host "Time range: June 25, 2024 - August 10, 2024`n" -ForegroundColor Cyan
...
Write-Host "`nComplete! Your project now has a realistic 1.5-month commit history!" -ForegroundColor Green
